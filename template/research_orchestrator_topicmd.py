...
def main() -> None:
    ...
    if not args.skip_final:
        ...
        # Use the skeptical agent as chair by default because it tends to preserve less unsupported material.
        final_prompt = final_memo_prompt(transcript, config)
        write_prompt_debug("final_memo_prompt", final_prompt)
        run_agent(agent_b, final_prompt, final_file, args.timeout)
